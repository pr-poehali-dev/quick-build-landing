...
// ── Snow/Wind zones by city — СП 20.13330.2017 Приложение Ж ─────────────────
const CITY_ZONES: Record<string, { snow: string; wind: string }> = {
  "Абакан":{ snow:"III", wind:"III" },
  "Альметьевск":{ snow:"III", wind:"II" },
  "Анадырь":{ snow:"V", wind:"V" },
  "Анапа":{ snow:"I", wind:"III" },
  "Ангарск":{ snow:"III", wind:"II" },
  "Арзамас":{ snow:"III", wind:"II" },
  "Архангельск":{ snow:"IV", wind:"III" },
  "Астрахань":{ snow:"I", wind:"III" },
  "Барнаул":{ snow:"IV", wind:"III" },
  "Белгород":{ snow:"III", wind:"II" },
  "Белорецк":{ snow:"IV", wind:"II" },
  "Биробиджан":{ snow:"II", wind:"II" },
  "Благовещенск":{ snow:"II", wind:"II" },
  "Братск":{ snow:"IV", wind:"II" },
  "Брянск":{ snow:"III", wind:"I" },
  "Великий Новгород":{ snow:"III", wind:"II" },
  "Владивосток":{ snow:"II", wind:"III" },
  "Владикавказ":{ snow:"II", wind:"II" },
  "Владимир":{ snow:"III", wind:"I" },
  "Волгоград":{ snow:"II", wind:"III" },
  "Волгодонск":{ snow:"II", wind:"III" },
  "Вологда":{ snow:"IV", wind:"II" },
  "Воркута":{ snow:"V", wind:"VI" },
  "Воронеж":{ snow:"III", wind:"II" },
  "Выборг":{ snow:"III", wind:"II" },
  "Горно-Алтайск":{ snow:"IV", wind:"II" },
  "Грозный":{ snow:"II", wind:"II" },
  "Дзержинск":{ snow:"III", wind:"II" },
  "Екатеринбург":{ snow:"III", wind:"II" },
  "Иваново":{ snow:"III", wind:"II" },
  "Ижевск":{ snow:"IV", wind:"II" },
  "Иркутск":{ snow:"III", wind:"II" },
  ...
  "Киров":{ snow:"IV", wind:"II" },
  "Кисловодск":{ snow:"II", wind:"II" },
  "Кострома":{ snow:"IV", wind:"II" },
  "Краснодар":{ snow:"I", wind:"III" },
  "Красноярск":{ snow:"III", wind:"III" },
  "Курган":{ snow:"IV", wind:"III" },
  "Курск":{ snow:"III", wind:"II" },
  "Кызыл":{ snow:"III", wind:"III" },
  "Липецк":{ snow:"III", wind:"II" },
  "Магадан":{ snow:"V", wind:"V" },
  "Магнитогорск":{ snow:"IV", wind:"III" },
  "Майкоп":{ snow:"II", wind:"II" },
  "Махачкала":{ snow:"I", wind:"IV" },
  "Минеральные Воды":{ snow:"II", wind:"III" },
  "Москва":{ snow:"III", wind:"I" },
  "Мурманск":{ snow:"IV", wind:"V" },
  "Набережные Челны":{ snow:"III", wind:"II" },
  "Нальчик":{ snow:"II", wind:"II" },
  "Нижневартовск":{ snow:"V", wind:"III" },
  "Нижний Новгород":{ snow:"III", wind:"II" },
  "Нижний Тагил":{ snow:"IV", wind:"II" },
  "Новокузнецк":{ snow:"IV", wind:"III" },
  "Новороссийск":{ snow:"I", wind:"VI" },
  "Новосибирск":{ snow:"IV", wind:"III" },
  "Норильск":{ snow:"V", wind:"VI" },
  "Ноябрьск":{ snow:"V", wind:"IV" },
  "Обнинск":{ snow:"III", wind:"I" },
  "Омск":{ snow:"III", wind:"III" },
  "Орёл":{ snow:"III", wind:"II" },
  "Оренбург":{ snow:"III", wind:"III" },
  "Орск":{ snow:"III", wind:"III" },
  "Пенза":{ snow:"III", wind:"II" },
  "Пермь":{ snow:"IV", wind:"II" },
  "Петрозаводск":{ snow:"IV", wind:"III" },
  "Петропавловск-Камчатский":{ snow:"V", wind:"V" },
  "Псков":{ snow:"III", wind:"II" },
  "Пятигорск":{ snow:"II", wind:"II" },
  ...
  "Тюмень":{ snow:"IV", wind:"III" },
  "Улан-Удэ":{ snow:"II", wind:"III" },
  "Ульяновск":{ snow:"III", wind:"II" },
  "Уфа":{ snow:"IV", wind:"II" },
  "Хабаровск":{ snow:"II", wind:"II" },
  "Ханты-Мансийск":{ snow:"IV", wind:"III" },
  "Чебоксары":{ snow:"III", wind:"II" },
  "Челябинск":{ snow:"IV", wind:"III" },
  "Череповец":{ snow:"IV", wind:"III" },
  "Черкесск":{ snow:"II", wind:"II" },
  "Чита":{ snow:"III", wind:"III" },
  "Южно-Сахалинск":{ snow:"IV", wind:"IV" },
  "Якутск":{ snow:"III", wind:"II" },
  "Ярославль":{ snow:"III", wind:"II" },
  // Малые и средние города — по региону
  "Абдулино":{ snow:"III", wind:"III" },
  "Азов":{ snow:"II", wind:"III" },
  "Алапаевск":{ snow:"IV", wind:"II" },
  "Алейск":{ snow:"IV", wind:"III" },
  "Алексин":{ snow:"III", wind:"II" },
  "Анжеро-Судженск":{ snow:"IV", wind:"III" },
  "Апатиты":{ snow:"V", wind:"V" },
  "Армавир":{ snow:"II", wind:"III" },
  ...
  "Балашов":{ snow:"III", wind:"III" },
  "Батайск":{ snow:"II", wind:"III" },
  "Белгород":{ snow:"III", wind:"II" },
  "Белогорск":{ snow:"II", wind:"II" },
  "Белорецк":{ snow:"IV", wind:"II" },
  "Белореченск":{ snow:"II", wind:"II" },
  "Бердск":{ snow:"IV", wind:"III" },
  "Березники":{ snow:"IV", wind:"II" },
  "Берёзовский":{ snow:"III", wind:"II" },
  "Бийск":{ snow:"IV", wind:"III" },
  "Бугульма":{ snow:"III", wind:"III" },
  "Бузулук":{ snow:"III", wind:"III" },
  "Великий Устюг":{ snow:"IV", wind:"II" },
  "Георгиевск":{ snow:"II", wind:"III" },
  "Глазов":{ snow:"IV", wind:"II" },
  "Губкин":{ snow:"III", wind:"II" },
  "Гудермес":{ snow:"II", wind:"II" },
  "Дербент":{ snow:"I", wind:"III" },
  ...
  "Ессентуки":{ snow:"II", wind:"II" },
  "Железногорск":{ snow:"III", wind:"II" },
  ...
  "Ишим":{ snow:"IV", wind:"III" },
  "Ишимбай":{ snow:"IV", wind:"III" },
  "Каменск-Уральский":{ snow:"III", wind:"II" },
  "Каменск-Шахтинский":{ snow:"II", wind:"III" },
  "Камышин":{ snow:"II", wind:"III" },
  "Керчь":{ snow:"I", wind:"III" },
  "Кирово-Чепецк":{ snow:"IV", wind:"II" },
  "Клин":{ snow:"III", wind:"I" },
  "Коломна":{ snow:"III", wind:"II" },
  "Комсомольск-на-Амуре":{ snow:"IV", wind:"III" },
  "Королёв":{ snow:"III", wind:"I" },
  "Кропоткин":{ snow:"I", wind:"III" },
  "Крымск":{ snow:"I", wind:"III" },
  "Кстово":{ snow:"III", wind:"II" },
  "Лабытнанги":{ snow:"V", wind:"IV" },
  "Ленинск-Кузнецкий":{ snow:"IV", wind:"III" },
  "Лобня":{ snow:"III", wind:"I" },
  "Люберцы":{ snow:"III", wind:"I" },
  "Мегион":{ snow:"V", wind:"III" },
  "Миасс":{ snow:"IV", wind:"III" },
  "Минусинск":{ snow:"III", wind:"III" },
  "Муром":{ snow:"III", wind:"II" },
  "Мытищи":{ snow:"III", wind:"I" },
  "Надым":{ snow:"V", wind:"V" },
  "Находка":{ snow:"II", wind:"III" },
  "Невинномысск":{ snow:"II", wind:"III" },
  "Нефтекамск":{ snow:"IV", wind:"II" },
  "Нефтеюганск":{ snow:"IV", wind:"III" },
  "Нижнекамск":{ snow:"III", wind:"II" },
  "Новокуйбышевск":{ snow:"III", wind:"III" },
  "Новомосковск":{ snow:"III", wind:"II" },
  "Новотроицк":{ snow:"III", wind:"III" },
  "Новочебоксарск":{ snow:"III", wind:"II" },
  "Новочеркасск":{ snow:"II", wind:"III" },
  "Новый Уренгой":{ snow:"V", wind:"V" },
  "Ногинск":{ snow:"III", wind:"I" },
  "Одинцово":{ snow:"III", wind:"I" },
  "Первоуральск":{ snow:"IV", wind:"II" },
  ...
  "Серпухов":{ snow:"III", wind:"II" },
  "Советский":{ snow:"V", wind:"III" },
  "Таганрог":{ snow:"II", wind:"III" },
  "Тобольск":{ snow:"IV", wind:"III" },
  "Уссурийск":{ snow:"II", wind:"III" },
  "Ухта":{ snow:"IV", wind:"III" },
  "Хасавюрт":{ snow:"I", wind:"III" },
