...
function QuizFullscreen({ onClose }: { onClose: () => void }) {
  ...
  // Таблица цен за кв.м по снеговому и ветровому районам
  ...
  // Каждые 100 кв.м умножаем цену на 1.1
  const areaMultiplier = Math.pow(1.1, Math.floor(area / 100));
